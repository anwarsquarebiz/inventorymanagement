...
export default function Create() {
    ...
    return (
        <AppLayout title="Create Metal">
            <Head title="Create Metal" />
            <div className="space-y-6">
                <div className="flex items-center space-x-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-semibold text-gray-900">Create New Metal</h1>
                        <p className="text-gray-600">Add a new metal type</p>
                    </div>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="flex justify-end space-x-4">
                        ...
                        >
                            ...
                            {processing ? 'Creating...' : 'Create Metal'}
                        </Button>
                    </div>
                </form>
            </div>
