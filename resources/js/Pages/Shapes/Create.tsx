...
export default function Create({ products }: CreateShapeProps) {
    ...
    return (
        <AppLayout title="Create Shape">
            <Head title="Create Shape" />
            <div className="space-y-6">
                <div className="flex items-center space-x-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-semibold text-gray-900">Create New Shape</h1>
                        <p className="text-gray-600">Add a new shape</p>
                    </div>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="flex justify-end space-x-4">
                        ...
                        <Button type="submit" disabled={processing} className="bg-emerald-600 hover:bg-emerald-700 text-white">
                            ...
                            {processing ? 'Creating...' : 'Create Shape'}
                        </Button>
                    </div>
                </form>
            </div>
