...
export default function Create({ metals }: CreateProps) {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        post(route('metal-vouchers.store'));
    };

    return (
        <AppLayout title="Create Metal Voucher">
            <Head title="Create Metal Voucher" />
            <div className="space-y-6">
                <div className="flex items-center space-x-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-semibold text-gray-900">Create Metal Voucher</h1>
                        <p className="text-gray-600">Add a new metal voucher with line items</p>
                    </div>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="flex justify-end space-x-4">
                        ...
                        <Button type="submit" disabled={processing} className="bg-emerald-600 hover:bg-emerald-700 text-white">
                            ...
                            {processing ? 'Creating...' : 'Create Metal Voucher'}
                        </Button>
                    </div>
                </form>
            </div>
