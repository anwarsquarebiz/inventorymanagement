...
export default function Create() {
  ...
  const submit = (e: React.FormEvent) => {
    e.preventDefault()
    post(route('workshop-requests.store'))
  }

  return (
    <AppLayout title="New Workshop Request">
      <Head title="New Workshop Request" />
      <div className="space-y-6">
        <div className="flex items-center space-x-4">
          ...
          <div>
            <h1 className="text-2xl font-semibold text-gray-900">Create Workshop Request</h1>
          </div>
        </div>
